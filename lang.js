function switchLang(){
  ...
  const categoryText = {
    ja:['--全て表示--', '最初のエリア', 'ベンチ', 'バッテリー、占い', '神社', 'こころ・羊の絵', '鏡', 'きぼう', 'その他の物体', 'いのり', '羊の世話', 'リサイクルショップ', '森のNPC', '自動販売機', '猫', '玩具型M2', '望遠鏡', 'だる・カフェ', 'シューティングゲーム', '研究所', 'アクションゲーム', 'たばこ', 'みらい', 'カジノ', '洞窟', '玩具型M1', '海岸', '防衛戦', '倒れている人', 'いろいろ', '最後の行動', 'エンディング'],
